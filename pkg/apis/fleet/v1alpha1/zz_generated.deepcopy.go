...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KyvernoPolicyConfig) DeepCopyInto(out *KyvernoPolicyConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KyvernoPolicyConfig.
func (in *KyvernoPolicyConfig) DeepCopy() *KyvernoPolicyConfig {
	if in == nil {
		return nil
	}
	out := new(KyvernoPolicyConfig)
