...
import (
	...
	v1alpha1 "kurator.dev/kurator/pkg/client-go/generated/listers/backups/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BackupV1alpha1().Backups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BackupV1alpha1().Backups(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *backupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backupsv1alpha1.Backup{}, f.defaultInformer)
}
