...
// FleetV1alpha1Client is used to interact with features provided by the fleet.kurator.dev group.
type FleetV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FleetV1alpha1Client) Fleets(namespace string) FleetInterface {
