...
import (
	...
	v1alpha1 "kurator.dev/kurator/pkg/apis/backups/v1alpha1"
...
// BackupV1alpha1Client is used to interact with features provided by the backup.kurator.dev group.
type BackupV1alpha1Client struct {
	restClient rest.Interface
}

func (c *BackupV1alpha1Client) Backups(namespace string) BackupInterface {
