...
var supportedNetworkModes = map[string]struct{}{
	plugin.NetworkModeFlat:    {},
	plugin.NetworkModeNonFlat: {},
}
...
func NewCmd(opts *generic.Options) *cobra.Command {
	...
	f.StringVar(&pluginArgs.NetworkMode, "network-mode", plugin.NetworkModeFlat, "The network of the istio remote cluster, support flat/non-flat mode, default value is falt.")
